...
| moose_scraper.js | Node.js (Playwright) | Scraper module used by the dashboard API to pull Moose stats per player and resolve Steam profiles; now scrapes PvP, Resources, and Farming tabs. | Runs via `npm start` (required by `server.js`) |
